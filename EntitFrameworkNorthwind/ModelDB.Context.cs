...
namespace EntitFrameworkNorthwind
{
    ...
    public partial class NORTHWNDEntities : DbContext
    {
        ...
        public virtual DbSet<view_heavy> view_heavy { get; set; }
    
        [DbFunction("NORTHWNDEntities", "fn_shippingTerm")]
        public virtual IQueryable<fn_shippingTerm_Result> fn_shippingTerm(Nullable<System.DateTime> ilkdate, Nullable<System.DateTime> sondate)
        {
            var ilkdateParameter = ilkdate.HasValue ?
                new ObjectParameter("ilkdate", ilkdate) :
                new ObjectParameter("ilkdate", typeof(System.DateTime));
    
            var sondateParameter = sondate.HasValue ?
                new ObjectParameter("sondate", sondate) :
                new ObjectParameter("sondate", typeof(System.DateTime));
    
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<fn_shippingTerm_Result>("[NORTHWNDEntities].[fn_shippingTerm](@ilkdate, @sondate)", ilkdateParameter, sondateParameter);
        }
        ...
        public virtual ObjectResult<sp_priceRange_Result> sp_priceRange(Nullable<int> minimumprice, Nullable<int> maximumprice)
        {
            var minimumpriceParameter = minimumprice.HasValue ?
                new ObjectParameter("minimumprice", minimumprice) :
                new ObjectParameter("minimumprice", typeof(int));
    
            var maximumpriceParameter = maximumprice.HasValue ?
                new ObjectParameter("maximumprice", maximumprice) :
                new ObjectParameter("maximumprice", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_priceRange_Result>("sp_priceRange", minimumpriceParameter, maximumpriceParameter);
        }
